...
app = Flask(__name__)
app.secret_key = "v20_final_zero_errors"
...
FOOTBALL_POOL = [
    {"match": "Bayern Munich vs RB Leipzig", "league": "Germany Bundesliga", "country": "Germany", "tip": "Over 1.5 Goals", "odd": "1.28", "wr": 94, "reason": "Bayern 2.4 avg home - 94% Over 1.5 - Best option"},
    {"match": "Manchester City vs Arsenal", "league": "England Premier League", "country": "England", "tip": "Over 1.5 Goals", "odd": "1.32", "wr": 92, "reason": "City 92% Over 1.5 home - 9/10 securing"},
    {"match": "Real Madrid vs Barcelona", "league": "Spain La Liga", "country": "Spain", "tip": "Over 1.5 Goals", "odd": "1.30", "wr": 93, "reason": "El Clasico avg 2.8 goals H2H - 93%"},
    {"match": "Flamengo vs Palmeiras", "league": "Brazil Serie A", "country": "Brazil", "tip": "Over 1.5 Goals", "odd": "1.35", "wr": 91, "reason": "Brazil avg 2.1 goals - 91% - Any league"},
    {"match": "Rivers United vs Enyimba", "league": "Nigeria NPFL", "country": "Nigeria", "tip": "Over 1.5 Goals", "odd": "1.40", "wr": 88, "reason": "NPFL avg 2.0 goals - 88% - Any league today"},
    {"match": "Kano Pillars vs Enugu Rangers", "league": "Nigeria NPFL", "country": "Nigeria", "tip": "Double Chance 1X", "odd": "1.22", "wr": 92, "reason": "Kano 80% home win - Double Chance 92% - Best per team"},
    {"match": "Mumbai City vs Kerala Blasters", "league": "India Super League", "country": "India", "tip": "Over 1.5 Goals", "odd": "1.38", "wr": 89, "reason": "ISL avg 2.3 goals - 89% - Any league"},
    {"match": "Hanoi FC vs Viettel", "league": "Vietnam V-League", "country": "Vietnam", "tip": "Over 1.5 Goals", "odd": "1.36", "wr": 90, "reason": "Vietnam avg 2.1 goals - 90%"},
    {"match": "Al Ahly vs Zamalek", "league": "Egypt Premier League", "country": "Egypt", "tip": "Over 1.5 Goals", "odd": "1.42", "wr": 87, "reason": "Egypt derby avg 1.9 goals - 87%"},
    {"match": "Kaizer Chiefs vs Orlando Pirates", "league": "South Africa PSL", "country": "South Africa", "tip": "Over 1.5 Goals", "odd": "1.45", "wr": 86, "reason": "Soweto derby avg 1.8 goals - 86%"},
    {"match": "PSG vs Lyon", "league": "France Ligue 1", "country": "France", "tip": "Over 1.5 Goals", "odd": "1.29", "wr": 93, "reason": "PSG 2.5 avg home - 93% - 9/10"},
    {"match": "Benfica vs Porto", "league": "Portugal Primeira", "country": "Portugal", "tip": "Over 1.5 Goals", "odd": "1.33", "wr": 91, "reason": "Benfica vs Porto avg 2.2 goals H2H - 91%"},
    {"match": "Ajax vs PSV", "league": "Netherlands Eredivisie", "country": "Netherlands", "tip": "Over 2.5 Goals", "odd": "1.55", "wr": 84, "reason": "Dutch avg 3.1 goals - Over 2.5 84% = 7-8/10 Pro"},
    {"match": "Celtic vs Rangers", "league": "Scotland Premiership", "country": "Scotland", "tip": "Over 1.5 Goals", "odd": "1.34", "wr": 90, "reason": "Old Firm avg 2.0 goals - 90%"},
    {"match": "Galatasaray vs Fenerbahce", "league": "Turkey Super Lig", "country": "Turkey", "tip": "Over 1.5 Goals", "odd": "1.31", "wr": 92, "reason": "Turkish derby avg 2.3 goals - 92%"},
    {"match": "Club America vs Chivas", "league": "Mexico Liga MX", "country": "Mexico", "tip": "Over 1.5 Goals", "odd": "1.37", "wr": 89, "reason": "Mexico clasico avg 2.0 goals - 89%"},
    {"match": "River Plate vs Boca Juniors", "league": "Argentina Primera", "country": "Argentina", "tip": "Over 1.5 Goals", "odd": "1.39", "wr": 88, "reason": "Superclasico avg 1.9 goals - 88%"},
    {"match": "Al Hilal vs Al Nassr", "league": "Saudi Pro League", "country": "Saudi Arabia", "tip": "Over 1.5 Goals", "odd": "1.30", "wr": 91, "reason": "Saudi avg 2.4 goals - 91%"},
    {"match": "Inter Miami vs LAFC", "league": "USA MLS", "country": "USA", "tip": "Over 1.5 Goals", "odd": "1.33", "wr": 90, "reason": "MLS avg 2.2 goals - 90%"},
    {"match": "Vipers vs KCCA", "league": "Uganda Premier League", "country": "Uganda", "tip": "Over 1.5 Goals", "odd": "1.41", "wr": 87, "reason": "Uganda avg 1.9 goals - 87%"},
]
...
def header_html(e=None):
    if e:
        ...
        return f"<div class='topbar'><div class='logo'>MASTERPICK<span>AI</span><span class='badge'>V20 LIVE</span></div><div style='font-size:11px'>{admin_btn}<span style='background:#162032;padding:6px 10px;border-radius:20px'>{e[:14]}</span> <a href='/logout' style='color:#6b7fa3;margin-left:8px;text-decoration:none'>Logout</a></div></div>"
    return f"<div class='topbar'><div class='logo'>MASTERPICK<span>AI</span><span class='badge'>V20 LIVE</span></div><div><a href='/login' style='background:#162032;color:#fff;padding:8px 14px;border-radius:10px;font-size:13px;text-decoration:none'>Login</a> <a href='/signup' style='background:#00ff88;color:#000;padding:8px 14px;border-radius:10px;font-size:13px;text-decoration:none;margin-left:6px;font-weight:700'>Sign Up</a></div></div>"
...
def home():
    ...
    if not email:
        html += f"<div style='padding:16px'><div style='background:#0e1525;border:1px solid #1e2a44;border-radius:24px;padding:24px;text-align:center'><h1><span class='live-dot'></span> LIVE - 15 Games Any League - 1am WAT Update</h1><p style='color:#8aa0c5'>No fallback - No API - Always Live</p><div style='margin:16px 0'><span class='stat'><b>{len(all_games)}</b><br><span class='league'>Live Today</span></span><span class='stat'><b>9/10</b><br><span class='league'>Free @{free_odds:.2f}</span></span><span class='stat'><b>1am WAT</b><br><span class='league'>Next Update</span></span></div><p style='color:#6b7fa3;font-size:11px'>Today: {CACHE['date']} - Next: {next_update}</p><br><a href='/signup' class='btn btn-primary'>Create Account Free</a><br><br><a href='/login' class='btn btn-dark'>Login</a></div></div></body></html>"
        return html
    html += f"<div style='padding:16px'><p style='color:#6b7fa3;font-size:11px'><span class='live-dot'></span> LIVE - Updated {CACHE['date']} - Next {next_update} - No fallback - Any league</p>"
    ...
    html += f"<div style='background:#0f1a14;border:1px solid #1a3a2a;border-radius:16px;padding:12px;margin:10px 0'><h3>FREE - 9/10 Securing @{free_odds:.2f} - LIVE</h3></div>"
    for g in free_games:
    ...
    html += "<div style='background:#1a120a;border:1px solid #3a2a1a;border-radius:16px;padding:12px;margin:18px 0 10px'><h3>PRO - 7-8/10 @4.50+ - LIVE</h3></div>"
    ...
    if user and user["plan"] == "pro" and user["status"] == "active":
        ...
        html += f"<div class='card' style='text-align:center;border-color:gold'><div class='match'>PRO LOCKED - {len(pro_games)} Games @4.50+ - 7-8/10 - LIVE</div><div class='league'>Any league - No fallback - Updates 1am WAT</div><br><a href='/plans' class='btn btn-primary'>Unlock Pro N1000</a></div>"
    html += "</div></body></html>"
    return html
...
def history_page():
    ...
    all_games = get_live_games()
    html = f"<html><head>{STYLE}</head><body>{header_html(email)}<div style='padding:16px'><h2>History - Past Predictions</h2><p style='color:#8aa0c5'>Updates daily 1am WAT - Any league</p><div style='margin:12px 0'><span class='stat'><b>{len(HISTORY)}</b><br><span class='league'>Days Saved</span></span><span class='stat'><b>{CACHE['date']}</b><br><span class='league'>Today</span></span></div>"
    if not HISTORY:
...
@app.route("/plans")
def plans():
    html = f"<html><head>{STYLE}</head><body>{header_html(session.get('email'))}<div style='padding:16px;max-width:500px;margin:0 auto'><h2>Plans - LIVE - 1am WAT Update</h2><p style='color:#8aa0c5'>Opay 09079789177 - Updates daily 1am WAT</p>"
    for price, days in [("1000", "3 Days"), ("2000", "7 Days"), ("5000", "15 Days"), ("10000", "25 Days"), ("15000", "30 Days")]:
        html += f"<div class='card'><div style='display:flex;justify-content:space-between'><div><div class='match'>N{price} - {days}</div><div class='league'>9/10 Free @1.50+ + 7-8/10 Pro @4.50+ - Live 1am</div></div><a href='/subscribe/{price}' class='btn btn-primary' style='width:auto'>I Paid</a></div></div>"
    html += "</div></body></html>"
    return html
...
def admin_page():
    ...
    if not e or not is_admin_user(e):
        return f"<html><head>{STYLE}</head><body>{header_html(e)}<div style='padding:40px;text-align:center'><h2>Access Denied - Admin Only</h2><p style='color:#8aa0c5'>Customers cannot access - Admin only section</p><br><a href='/' class='btn btn-dark'>Back Home</a></div></body></html>"
    all_games = get_live_games()
    total = len(USERS)
    free_c = len([u for u in USERS.values() if u.get("plan") == "free"])
    pro_c = len([u for u in USERS.values() if u.get("plan") == "pro" and u.get("status") == "active"])
    pending_c = len([u for u in USERS.values() if u.get("status") == "pending"])
    now_wat = datetime.utcnow() + timedelta(hours=1)
    html = f"<html><head>{STYLE}</head><body>{header_html(e)}<div style='padding:16px'><h2>ADMIN ONLY - Customers Cannot Access</h2><p style='color:#8aa0c5'>Monitor users + Approve Pro requests - History</p><div style='margin:12px 0'><span class='stat'><b>{total}</b><br><span class='league'>Total Users</span></span><span class='stat'><b>{free_c}</b><br><span class='league'>Free</span></span><span class='stat'><b>{pro_c}</b><br><span class='league'>Active Pro</span></span><span class='stat'><b>{pending_c}</b><br><span class='league'>Pending</span></span><span class='stat'><b>{len(all_games)}</b><br><span class='league'>Live Today</span></span><span class='stat'><b>{CACHE['date']}</b><br><span class='league'>Date WAT</span></span><span class='stat'><b>{now_wat.strftime('%H:%M')}</b><br><span class='league'>Now WAT</span></span></div>"
    if pending_c > 0:
        ...
        for em, u in USERS.items():
            if u.get("status") == "pending":
                html += f"<div class='card' style='border-color:orange'><div class='match'>{em}</div><div class='league'>Plan: N{u.get('pending')} - Joined: {u.get('joined', '-')} - Status: {u.get('status')}</div><br><div style='display:flex;gap:8px'><a href='/admin/approve/{em}' class='btn btn-primary' style='width:auto;background:#00ff88;color:#000;font-weight:800'>APPROVE PRO</a> <a href='/admin/reject/{em}' class='btn btn-dark' style='width:auto'>REJECT</a></div></div>"
    else:
...
def signup():
    ...
    if request.method == "POST":
        ...
        if em in USERS:
            ...
            return redirect("/")
    err_html = f"<div class='card' style='border-color:red'>{err}</div>" if err else ""
    return f"<html><head>{STYLE}</head><body><div class='topbar'><div class='logo'>MASTERPICK<span>AI</span></div></div><div class='login-wrap'><h2>Sign Up - 9/10 @1.50 Live</h2>{err_html}<form method='post'><input class='input' name='email' placeholder='Email' required><input class='input' name='pass' type='password' placeholder='Password' required><br><br><button class='btn btn-primary'>Create Free</button></form></div></body></html>"
